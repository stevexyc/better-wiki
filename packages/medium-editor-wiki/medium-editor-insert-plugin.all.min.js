...
! function (a) {
    ...
    MediumEditor.prototype.serialize = function () {
        ...
        return "string" == typeof c && a.fn.mediumInsert.insert[c] ? void a.fn.mediumInsert.insert[c]() : (a.fn.mediumInsert.settings = a.extend(a.fn.mediumInsert.settings, c), this.each(function () {
            ...
            }), a.fn.mediumInsert.insert.init(a(this));
            for (var c in a.fn.mediumInsert.settings.addons) {
        ...
        setPlaceholders: function () {
            ...
            if (0 === Object.keys(a.fn.mediumInsert.settings.addons).length) return !1;
            for (var h in a.fn.mediumInsert.settings.addons) g += "<li>" + b[h].insertButton(f) + "</li>";
            g += "</ul>", g = '<div class="mediumInsert" contenteditable="false"><div class="mediumInsert-buttons"><a class="mediumInsert-buttonsShow">+</a>' + g + '</div><div class="mediumInsert-placeholder"></div></div>', d.is(":empty") && d.html("<p><br></p>"), d.keyup(function () {
                var b, e = d.children(":last");
                e.hasClass("mediumInsert") && e.find(".mediumInsert-placeholder").children().length > 0 && d.append("<p><br></p>"), navigator.userAgent.match(/firefox/i) && a(".mediumInsert .mediumInsert-placeholder:empty", d).each(function () {
...
function (a) {
    a.fn.mediumInsert.registerAddon("images", {
        ...
        uploadCompleted: function (b) {
            var c, d = a(".progress:first", this.$el);
            d.attr("value", 100), d.html(100), d.before('<div class="mediumInsert-images"><img src="' + b.responseText + '" draggable="true" alt=""></div>'), c = d.siblings("img"), d.remove(), c.load(function () {
                c.parent().mouseleave().mouseenter()
            }), a.fn.mediumInsert.insert.$el.keyup()
        },
        ...
        setImageEvents: function () {
            this.$el.on("mouseenter", ".mediumInsert-images", function () {
                ...
                0 === a(this).parent().siblings().length && a(this).parent().parent().parent().removeClass("small"), a(this).parent().remove(), a.fn.mediumInsert.insert.deselect()
            })
        },
        setDragAndDropEvents: function () {
            ...
            a(document).on("dragover", "body", function () {
                ...
                var c;
                b.preventDefault(), a.fn.mediumInsert.settings.enabled !== !1 && (a(this).removeClass("hover"), a("body").removeClass("hover"), a(this).attr("contenteditable", !1), c = b.originalEvent.dataTransfer.files, c.length > 0 ? d.uploadFiles(a(".mediumInsert-placeholder", this), c) : f === !0 ? f = !1 : (a(".mediumInsert-placeholder", this).append('<div class="mediumInsert-images">' + b.originalEvent.dataTransfer.getData("text/html") + "</div>"), a("meta", this).remove(), e = !0))
            })
        }
    })
}(jQuery),
