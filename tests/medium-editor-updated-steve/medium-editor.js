    ...
    MediumEditor.prototype = {
        ...
        serialize: function () {
            ...
            for (i = 0; i < this.elements.length; i += 1) {
                ...
                content[elementid] = {
                    value: this.elements[i].innerHTML.replace(/\s+/g, ' ').trim()
                };
            }
            return content;
        },
        ...
        showAnchorPreview: function (anchorEl) {
            ...
            if (anchorEl.target !== '_blank') {
                self.anchorPreview.querySelector('i').textContent = anchorEl.attributes.href.textContent;
            } else {
        ...
        observeAnchorPreview: function (anchorEl) {
            var self = this,
                ...
                interval_timer = setInterval(function () {
                    ...
                    if (durr > self.options.anchorPreviewHideDelay) {// hide the preview 1/2 second after mouse leaves the link
            ...
            if (this.activeAnchor) {
                ...
                setTimeout(function () {
                    if (self.activeAnchor) {
                        if (self.activeAnchor.target !== '_blank' ) {
                            self.showAnchorForm(self.activeAnchor.attributes.href.textContent);
                        } else {
        ...
        createLink: function (input) {
            ...
            if (this.isLink(input.value)) {
                ...
                document.execCommand('createLink', false, input.value);
                // var html = '<span class="ink">'+input.value+'</span>';
